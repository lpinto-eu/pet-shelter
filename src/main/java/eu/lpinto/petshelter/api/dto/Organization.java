...
public class Organization extends Entity implements Serializable {
    ...
    public Organization(final String logo, final List<User> users, final List<Animal> animals, final Integer id, final String name, final Calendar created, final Calendar updated) {
